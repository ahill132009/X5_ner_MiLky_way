...
async def main():
    async with Pyaterochka(proxy="http://45.80.69.102:3128", debug=True, autoclose_browser=False, trust_env=False) as API:
        ...
        catalog = await API.categories_list(subcategories=True, mode=PurchaseMode.DELIVERY)
